...
export class BannerComponent implements OnInit, OnDestroy {
  ...
  constructor(private modal: NzModalService, private adminService: AdminService, private bannersService: BannersService, private msg: NzMessageService) { }
  ...
  getBanners(): void {
    ...
    this.getSub = this.bannersService.get().subscribe({
      next: data => {
  ...
  getActiveBanners(): void {
    this.bannersService.getTrue().subscribe({
      next: (data) => {
  ...
  deleteBanner(id: number): void {
    this.tableLoading = true;
    this.deleteSub = this.bannersService.delete(id).subscribe({
      next: () => {
  ...
  setActiveBanner(): void {
    ...
    this.bannersService.update(listOfId).subscribe({
      next: () => {
        this.getBanners();
